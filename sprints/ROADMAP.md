...
| R6 | **Monopolização do registro** — o texto é inviolável, mas nada impede uma única carteira de registrar a Bíblia inteira (~68 SOL) e esvaziar o caráter coletivo do projeto. Não é corrupção de dado: é risco de produto. Mitigações possíveis (limite por carteira é contornável com várias carteiras; janela de lançamento por livro; nada) precisam de decisão consciente. | Decisão de produto → ADR antes do go-live (**S06**) |
